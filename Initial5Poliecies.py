...
Black Jack Spring21
  ...
  This program checks for five intial policies:
        Stand when hand is >= 17 
        Stand when hand is >= 17 and is hard.
        Always stand
        Always hit
        Stand when hand is >= 12 and is hard.
...
if __name__ == '__main__':
    ...
    #sim(PlayerPolicyPoints,if (not 0) then ChecksDealerFaceUpCard else no checking,games,deckType,hard/soft)
    sim(17,0,1000000,1,False)
    sim(17,0,1000000,1,True)
    sim(0,0,1000000,1,False)
    sim(22,0,1000000,1,False)
    sim(12,0,1000000,1,True)
    
    sim(17,0,1000000,2,False)
    sim(17,0,1000000,2,True)
    sim(0,0,1000000,2,False)
    sim(22,0,1000000,2,False)
    sim(12,0,1000000,2,True)
